...
const { chains, provider } = configureChains(
  [mainnet, polygon,polygonMumbai, optimism, arbitrum, gnosisChain],
  [
  ...
  return (
    <WagmiConfig client={wagmiClient}>
      <RainbowKitProvider
        ...
        chains={chains}
        initialChain={80001} // Optional, initialChain={1}, initialChain={chain.mainnet}, initialChain={gnosisChain}
