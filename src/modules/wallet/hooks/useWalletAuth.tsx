...
export function useWalletAuth() {
  const { setWallet, setProvider, wallet, counterContract, setCounterContract } = useWalletContext()
  ...
  const COUNTER_CONTRACT_ADDRESS = '0xF1874Bf95AD065038C841593F155bE255495B961'
  ...
  async function connect() {
    ...
    try {
      ...
      const contract = new ethers.Contract(COUNTER_CONTRACT_ADDRESS, countContractAbi, instanceProvider.getSigner())
